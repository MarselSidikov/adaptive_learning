...
CREATE TABLE Lessons (id INT , main_mat_url VARCHAR(100), extra_material_url VARCHAR (100), block_urls VARCHAR (1000), block_test_ids INT, main_test_ids, PRIMARY KEY (id),FOREIGN KEY (main_test_id) REFERENCES Test (id),FOREIGN KEY (block_test_id) REFERENCES Test(id));
